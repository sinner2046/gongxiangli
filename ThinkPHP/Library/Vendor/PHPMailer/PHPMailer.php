...
class PHPMailer
{
    ...
    /**
     * An instance of the PHPMailer.class OAuth class.
     *
     * @var OAuth
     */
     ...
     * Options: An empty string for PHPMailer.class default, whitespace for none, or a string to use.
     *
     * @var string
     */
    public $XMailer = '';
     ...
     *                     [['joe@example.com', 'Joe Member'], ['zoe@example.com', 'Zoe Member']]
     *
     * @return string
     */
